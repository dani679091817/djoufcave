...
@pushOnce('scripts')
    ...
    >
        <!-- Grid Card -->
        <div
            class="1180:transtion-all group w-full rounded-md shadow-gold 1180:relative 1180:grid 1180:content-start 1180:overflow-hidden 1180:duration-300 1180:hover:shadow-gold-lg"
            v-if="mode != 'list'"
        >
        ...
        <!-- List Card -->
        <div
            class="relative flex max-w-max grid-cols-2 gap-4 overflow-hidden rounded shadow-gold max-sm:flex-wrap"
            v-else
        >
