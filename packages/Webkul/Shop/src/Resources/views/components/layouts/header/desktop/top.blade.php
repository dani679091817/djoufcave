...
<v-topbar>
    <!-- Shimmer Effect -->
    <div class="flex items-center justify-between border border-b border-l-0 border-r-0 border-t-0 border-white/15 px-16 text-white" style="background:#0F347D; color:#ffffff;">
        <!-- Currencies -->
...
@pushOnce('scripts')
    ...
    >
        <div class="flex w-full items-center justify-between border border-b border-l-0 border-r-0 border-t-0 border-white/15 px-16 text-white" style="background:#0F347D; color:#ffffff;">
